...
This is a collection of .NET libraries (.NET Framework, .NET Core and .NET) to provide easy server-side support for the [DataTables](https://datatables.net/) Javascript library - _the_ Javascript table library.
